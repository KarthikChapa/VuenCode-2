#!/usr/bin/env python3
"""
Comprehensive test script to compare different VuenCode approaches:
1. Standard Enhanced Video Processing
2. VLM-Enhanced Processing
3. Pyramid Context System
"""
...
async def test_vlm_enhanced_approach(video_data: bytes, query: str):
    """Test VLM-enhanced processing."""
    print("\n🤖 Testing VLM-Enhanced Processing...")
...
async def test_temporal_queries(video_data: bytes):
    ...
    temporal_queries = [
        ...
        "How many frame changes happened in video?",
        "Describe the scene at 0:10"
    ]
...
async def compare_approaches():
    ...
    print("=== VuenCode Approach Comparison Test ===")
    ...
    test_queries = [
        ...
        "What objects and animals can you see?"
    ]
    ...
    for query in test_queries:
        ...
        # Test VLM-Enhanced Approach
        try:
            result = await test_vlm_enhanced_approach(video_data, query)
            query_results.append(result)
        except Exception as e:
            print(f"❌ VLM approach failed: {e}")
            query_results.append({
                "approach": "VLM-Enhanced",
                "processing_time": 0,
                "result": {"error": str(e)},
